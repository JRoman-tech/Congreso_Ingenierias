...
CREATE TABLE IF NOT EXISTS validaciones (
  ...
  CONSTRAINT fk_validacion_participante
    FOREIGN KEY (participante_id) REFERENCES participantes (id)
    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS validacion_academica (
  ...
  CONSTRAINT fk_academica_validacion
    FOREIGN KEY (validacion_id) REFERENCES validaciones (id)
    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS historial_validacion (
  ...
  CONSTRAINT fk_historial_validacion
    FOREIGN KEY (validacion_id) REFERENCES validaciones (id)
    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
